...
<body>
    <header class="mb">
        <nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:#4B527E">
            <div class="container">
                ...
                <nav class="collapse navbar-collapse justify-content-end" id="collapsibleNavbar">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('notasxml.index')}}">Notas</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('notasxml.create')}}">Cadastrar</a>
                        </li>
                    </ul>
                </nav>
            </div>
